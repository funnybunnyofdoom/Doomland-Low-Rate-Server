...
function ConvertSeconds(seconds, mode, x){
	...
	if(days != 0){
		result += days + " " + ((days == 1) ? "<span class='time-title'>day</span> " : "<span class='time-title'>days</span> ");
	}

	if(hours != 0){
		result += hours + " " + ((hours == 1) ? "<span class='time-title'>hr</span> " : " <span class='time-title'>hrs</span> ");
	}

	if(minutes != 0){
		result += minutes + " " + ((minutes == 1) ? "<span class='time-title'>min</span> " : "<span class='time-title'>mins</span> ");
	}
